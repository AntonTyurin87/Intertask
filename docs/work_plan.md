...
- [x] Чистота кода?
- [ ] Описать первичный анализ в соответствующем файле
- [ ] Исправить грамматические ошибки в названии папок и функций
- [ ] Ввести работу с БД через экземпляр структуры
