...
- [x] Составить схему требований к задаче
...
- [x] Сделать .sql файл для создания пустой базы

#### Реализация основного функционала в "in memory".
- [x] Реализовать интерфейс, метод для БД и метод для "in memory".
- [x] Создать точку выбора параметров БД или "in memory".
- [x] Составить предварительный план тестирования. Или описание подходов. Но тестов явно не хватает(

#### Анализ промежуточного результата 2.
- [x] Как выглядит архитектура папок и пакетов.
- [x] Чистота кода?
- [x] Составить скрипты для передачи входных данных в приложение.
...
- [x] Проверить работоспособность Docker образа.

#### Подчистка проекта.
- [x] Прочитать код каждого файла и проверить комментарии. При необходимости поправить.
- [x] Прочитать сопутствующие текстовые файлы. При необходимости поправить.
- [x] Прочитать сопутствующие текстовые файлы. При необходимости поправить.
- [x] Особенно внимательно прочитать README.md.
- [x] Проверить функционал через клонирование и запуск проекта с GitHub в отдельный новый репозиторий.


#### Список неопределённостей в порядке от новой к старой.
- [x] Формировние Docker образа. На основе образа с Golang, на пустом Linux, на образа с Postgres.
...
- [x] Заполнить makefile
- [x] Заполнить READMME.md
- [x] Проверить и почистить analisis.md
- [x] Проверить и почистить task_text.md
- [x] Проверить и почистить test_plan.md
- [x] Проверить и почистить work_plan.md
...
##### Файл initdb.go
- [x] Общий вид файла и кода до функций
- [x] Данные для подключения к БД необходимо братьиз скрипта
...
- [x] Комментари к переменным, типам и структурам в файле subscriptionhandler.go. Частично, там, где понимаю.
